MeDIAuto Anonymization 1.10.1 — Windows x64 · 내부 연구용
...
색상 프로파일은 기본 유지입니다. 원본에 ICC가 없으면 추가하지 않으며, 있는데 보존할 수 없으면 오류로 안내합니다.
명시적으로 제외하면 표시 색상이 달라질 수 있습니다. 보존한 프로파일 내부 정보는 기존처럼 별도 검토 대상으로 기록합니다.
