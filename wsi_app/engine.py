...
def create_anonymized_tiff(source, output, *, run_id=None, pixels_reviewed=False, progress=None, cancelled=None,
                          ...
                          preserve_mpp=True, compression="preserve", pyramid=True):
    ...
    report = anonymize_wsi(source, output, run_id=run_id, pixels_reviewed=pixels_reviewed,
                           ...
                           export_csv=export_csv, include_filename=include_filename, rename_output=rename_output,
                           preserve_mpp=preserve_mpp, compression=compression, pyramid=pyramid)
